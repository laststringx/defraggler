...
// points fetch
$result=$mysqli->query("SELECT points_10,total FROM `result` WHERE team_name='$team_name'") or die ("databse fetch problem");
...
{
localStorage.total10=Number(localStorage.total10)+1;
  if (localStorage.clickcount10>0)  //sessionStorage say tab close karnay prr reset hojayga
    {
    localStorage.clickcount10=Number(localStorage.clickcount10)-1;
	 document.getElementById("result").innerHTML="optimal number of initial moves(for full credits): "+localStorage.clickcount10;
    }
   else
    {
	if(localStorage.extra10>0)
	{
	 localStorage.extra10=Number(localStorage.extra10)-1;
document.getElementById("result").innerHTML="extra number of moves(less credits) "+localStorage.extra10;
}
if(localStorage.extra10<=0)
 {
...
//buy localstorage
localStorage.extra10=Number(localStorage.extra10)+v;
...
document.getElementById('numberofcredits1').innerHTML="You have "+vall[1]+" credits";
	...
	var optimal = localStorage.getItem('clickcount10');
	document.getElementById("optimal").value=optimal;
	var extra = localStorage.getItem('extra10');
...
$("#credit").hide();
	...
	var total = localStorage.getItem('total10');
	...
	document.getElementById("credit").style.display='none';
		...
		document.getElementById("A").innerHTML='<div id="box"><img src="images/10/A.png"></div>';
		document.getElementById("B").innerHTML='<div id="box"><img src="images/10/B.png"></div>';
		document.getElementById("C").innerHTML='<div id="box"><img src="images/10/C.png"></div>';
		document.getElementById("D").innerHTML='<div id="box"><img src="images/10/D.png"></div>';
		document.getElementById("E").innerHTML='<div id="box"><img src="images/10/E.png"></div>';
		document.getElementById("F").innerHTML='<div id="box"><img src="images/10/F.png"></div>';
		document.getElementById("G").innerHTML='<div id="box"><img src="images/10/G.png"></div>';
		document.getElementById("H").innerHTML='<div id="box"><img src="images/10/H.png"></div>';
		document.getElementById("I").innerHTML='<div id="box"><img src="images/10/I.png"></div>';
		
		document.getElementById("J").innerHTML='<div id="box"><img src="images/10/J.png"></div>';
		document.getElementById("K").innerHTML='<div id="box"><img src="images/10/K.png"></div>';
		document.getElementById("L").innerHTML='<div id="box"><img src="images/10/L.png"></div>';
	...
	<title>Question.10 || Defraggler</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Defraggler || Question-10</a>
    </div>
	  ...
	  <div id="modal1" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
				...
				<p> Maximum points for correct answer : 100<br>
				<br>Number of optimal moves : 10<br><br>
				...
				just refresh the page but your moves will not be refunded.
				<br><br>
...
$result=$mysqli->query("SELECT temp_10 FROM `match` WHERE team_name='$team_name'") or die ("databse fetch problem");
while($row=mysqli_fetch_array($result))
{
...
<div id="arrDebug"></div>
<form method="post" action="check10.php">
...
<div class="row">
	...
	<input type="submit" class="btn btn-primary" name="action" onclick="saveArrangableNodes()" value="submit"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	<input type="submit" class="btn btn-primary" name="action" onclick="saveArrangableNodes()" value="skip"/><br><br>
	<div class="col-md-10">
...
write "3 4 +" rather than "3 + 4". If there are multiple operations, the operator 
is given immediately after its second operand; so the expression written 
"3 - 4 + 5" would be written "3 4 - 5 +" first subtract 4 from 3, then add 5 to that.
...
Input : First line contains the t test cases followed by t lines of Strings.

Ouput: The RNP of each string per line.
...
Question:
Write the output of the given input 
((a+t)*((b+(a+c))^(c+d)))
</pre>
</div>
 </div>
