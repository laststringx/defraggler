...
// points fetch
$result=$mysqli->query("SELECT points_4,total FROM `result` WHERE team_name='$team_name'") or die ("databse fetch problem");
...
{
localStorage.total4=Number(localStorage.total4)+1;
  if (localStorage.clickcount4>0)  //sessionStorage say tab close karnay prr reset hojayga
    {
    localStorage.clickcount4=Number(localStorage.clickcount4)-1;
	 document.getElementById("result").innerHTML="optimal number of initial moves(for full credits): "+localStorage.clickcount4;
    }
   else
    {
	if(localStorage.extra4>0)
	{
	 localStorage.extra4=Number(localStorage.extra4)-1;
document.getElementById("result").innerHTML="extra number of moves(less credits) "+localStorage.extra4;
}
if(localStorage.extra4<=0)
 {
...
//buy localstorage
localStorage.extra4=Number(localStorage.extra4)+v;
...
document.getElementById('numberofcredits1').innerHTML="You have "+vall[1]+" credits";
	...
	var optimal = localStorage.getItem('clickcount4');
	document.getElementById("optimal").value=optimal;
	var extra = localStorage.getItem('extra4');
...
$("#credit").hide();
	...
	var total = localStorage.getItem('total4');
	...
	document.getElementById("credit").style.display='none';
		...
		document.getElementById("A").innerHTML='<div id="box"><img src="images/4/A.png"></div>';
		document.getElementById("B").innerHTML='<div id="box"><img src="images/4/B.png"></div>';
		document.getElementById("C").innerHTML='<div id="box"><img src="images/4/C.png"></div>';
		document.getElementById("D").innerHTML='<div id="box"><img src="images/4/D.png"></div>';
		document.getElementById("E").innerHTML='<div id="box"><img src="images/4/E.png"></div>';
		document.getElementById("F").innerHTML='<div id="box"><img src="images/4/F.png"></div>';
		document.getElementById("G").innerHTML='<div id="box"><img src="images/4/G.png"></div>';
		document.getElementById("H").innerHTML='<div id="box"><img src="images/4/H.png"></div>';
		document.getElementById("I").innerHTML='<div id="box"><img src="images/4/I.png"></div>';
	...
	<title>Question.4 || Defraggler</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Defraggler || Question-4</a>
    </div>
...
$result=$mysqli->query("SELECT temp_4 FROM `match` WHERE team_name='$team_name'") or die ("databse fetch problem");
while($row=mysqli_fetch_array($result))
{
...
Kushal is playing cards along with Atul, Pranav and Amal.
Unfortunately he got the worst cards. He is frustated and started
to arrange the cards. 
Help him to arrange the cards in increasing sequence.

Input: An array containing the value of 13 cards

Output: an array of cards in increaing order of their value. 

Example:
Input : 6 9 3 9 7 4 3 2 7 2 6 7 8 

Output:
sorted elements:
2 2 3 3 4 6 6 7 7 7 8 9 9 
</pre>
</div>
 </div>
</body>
