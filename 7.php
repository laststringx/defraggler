...
// points fetch
$result=$mysqli->query("SELECT points_7,total FROM `result` WHERE team_name='$team_name'") or die ("databse fetch problem");
...
{
localStorage.total7=Number(localStorage.total7)+1;
  if (localStorage.clickcount7>0)  //sessionStorage say tab close karnay prr reset hojayga
    {
    localStorage.clickcount7=Number(localStorage.clickcount7)-1;
	 document.getElementById("result").innerHTML="optimal number of initial moves(for full credits): "+localStorage.clickcount7;
    }
   else
    {
	if(localStorage.extra7>0)
	{
	 localStorage.extra7=Number(localStorage.extra7)-1;
document.getElementById("result").innerHTML="extra number of moves(less credits) "+localStorage.extra7;
}
if(localStorage.extra7<=0)
 {
...
//buy localstorage
localStorage.extra7=Number(localStorage.extra7)+v;
...
document.getElementById('numberofcredits1').innerHTML="You have "+vall[1]+" credits";
	...
	var optimal = localStorage.getItem('clickcount7');
	document.getElementById("optimal").value=optimal;
	var extra = localStorage.getItem('extra7');
...
$("#credit").hide();
	...
	var total = localStorage.getItem('total7');
	...
	document.getElementById("credit").style.display='none';
		...
		document.getElementById("A").innerHTML='<div id="box"><img src="images/7/A.png"></div>';
		document.getElementById("B").innerHTML='<div id="box"><img src="images/7/B.png"></div>';
		document.getElementById("C").innerHTML='<div id="box"><img src="images/7/C.png"></div>';
		document.getElementById("D").innerHTML='<div id="box"><img src="images/7/D.png"></div>';
		document.getElementById("E").innerHTML='<div id="box"><img src="images/7/E.png"></div>';
		document.getElementById("F").innerHTML='<div id="box"><img src="images/7/F.png"></div>';
		document.getElementById("G").innerHTML='<div id="box"><img src="images/7/G.png"></div>';
		document.getElementById("H").innerHTML='<div id="box"><img src="images/7/H.png"></div>';
		document.getElementById("I").innerHTML='<div id="box"><img src="images/7/I.png"></div>';
		document.getElementById("J").innerHTML='<div id="box"><img src="images/7/J.png"></div>';
		document.getElementById("K").innerHTML='<div id="box"><img src="images/7/K.png"></div>';
	...
	<title>Question.7 || Defraggler</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Defraggler || Question-7</a>
    </div>
...
$result=$mysqli->query("SELECT temp_7 FROM `match` WHERE team_name='$team_name'") or die ("databse fetch problem");
while($row=mysqli_fetch_array($result))
{
...
Task is to reverse the order of words in a given string.
...
Input : Amal is a Hacker

Output: Hacker a is Amal
