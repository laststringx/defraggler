...
// points fetch
$result=$mysqli->query("SELECT points_5,total FROM `result` WHERE team_name='$team_name'") or die ("databse fetch problem");
...
{
localStorage.total5=Number(localStorage.total5)+1;
  if (localStorage.clickcount5>0)  //sessionStorage say tab close karnay prr reset hojayga
    {
    localStorage.clickcount5=Number(localStorage.clickcount5)-1;
	 document.getElementById("result").innerHTML="optimal number of initial moves(for full credits): "+localStorage.clickcount5;
    }
   else
    {
	if(localStorage.extra5>0)
	{
	 localStorage.extra5=Number(localStorage.extra5)-1;
document.getElementById("result").innerHTML="extra number of moves(less credits) "+localStorage.extra5;
}
if(localStorage.extra5<=0)
 {
...
//buy localstorage
localStorage.extra5=Number(localStorage.extra5)+v;
...
document.getElementById('numberofcredits1').innerHTML="You have "+vall[1]+" credits";
	...
	var optimal = localStorage.getItem('clickcount5');
	document.getElementById("optimal").value=optimal;
	var extra = localStorage.getItem('extra5');
...
$("#credit").hide();
	...
	var total = localStorage.getItem('total5');
	...
	document.getElementById("credit").style.display='none';
		...
		document.getElementById("A").innerHTML='<div id="box"><img src="images/5/A.png"></div>';
		document.getElementById("B").innerHTML='<div id="box"><img src="images/5/B.png"></div>';
		document.getElementById("C").innerHTML='<div id="box"><img src="images/5/C.png"></div>';
		document.getElementById("D").innerHTML='<div id="box"><img src="images/5/D.png"></div>';
		document.getElementById("E").innerHTML='<div id="box"><img src="images/5/E.png"></div>';
		document.getElementById("F").innerHTML='<div id="box"><img src="images/5/F.png"></div>';
		document.getElementById("G").innerHTML='<div id="box"><img src="images/5/G.png"></div>';
		document.getElementById("H").innerHTML='<div id="box"><img src="images/5/H.png"></div>';
		
		document.getElementById("I").innerHTML='<div id="box"><img src="images/5/I.png"></div>';
	...
	<title>Question.5 || Defraggler</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Defraggler || Question-5</a>
    </div>
...
$result=$mysqli->query("SELECT temp_5 FROM `match` WHERE team_name='$team_name'") or die ("databse fetch problem");
while($row=mysqli_fetch_array($result))
{
...
Vijay designed a robot and named it "Alok". They both live in a country 
where there is a currency of each positive number like 1,2,3,4,5,6, and so on.
Vijay taught Alok calculations.
Once Vijay took Alok to a resturant where he got a bill of n unit currency.
Vijay asked Alok to pay the bill.
BUT.....
Alok asked vijay what combination of currency he should pay.

Input : A single line containing n
Output : The combination in which the bill could be paid per line.
For Example:
