...
// points fetch
$result=$mysqli->query("SELECT points_9,total FROM `result` WHERE team_name='$team_name'") or die ("databse fetch problem");
...
{
localStorage.total9=Number(localStorage.total9)+1;
  if (localStorage.clickcount9>0)  //sessionStorage say tab close karnay prr reset hojayga
    {
    localStorage.clickcount9=Number(localStorage.clickcount9)-1;
	 document.getElementById("result").innerHTML="optimal number of initial moves(for full credits): "+localStorage.clickcount9;
    }
   else
    {
	if(localStorage.extra9>0)
	{
	 localStorage.extra9=Number(localStorage.extra9)-1;
document.getElementById("result").innerHTML="extra number of moves(less credits) "+localStorage.extra9;
}
if(localStorage.extra9<=0)
 {
...
//buy localstorage
localStorage.extra9=Number(localStorage.extra9)+v;
...
document.getElementById('numberofcredits1').innerHTML="You have "+vall[1]+" credits";
	...
	var optimal = localStorage.getItem('clickcount9');
	document.getElementById("optimal").value=optimal;
	var extra = localStorage.getItem('extra9');
...
$("#credit").hide();
	...
	var total = localStorage.getItem('total9');
	...
	document.getElementById("credit").style.display='none';
		...
		document.getElementById("A").innerHTML='<div id="box"><img src="images/9/A.png"></div>';
		document.getElementById("B").innerHTML='<div id="box"><img src="images/9/B.png"></div>';
		document.getElementById("C").innerHTML='<div id="box"><img src="images/9/C.png"></div>';
		document.getElementById("D").innerHTML='<div id="box"><img src="images/9/D.png"></div>';
		document.getElementById("E").innerHTML='<div id="box"><img src="images/9/E.png"></div>';
		document.getElementById("F").innerHTML='<div id="box"><img src="images/9/F.png"></div>';
		document.getElementById("G").innerHTML='<div id="box"><img src="images/9/G.png"></div>';
		document.getElementById("H").innerHTML='<div id="box"><img src="images/9/H.png"></div>';
		document.getElementById("I").innerHTML='<div id="box"><img src="images/9/I.png"></div>';
		
		document.getElementById("J").innerHTML='<div id="box"><img src="images/9/J.png"></div>';
		document.getElementById("K").innerHTML='<div id="box"><img src="images/9/K.png"></div>';
	...
	<title>Question.9 || Defraggler</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Defraggler || Question-9</a>
    </div>
...
$result=$mysqli->query("SELECT temp_9 FROM `match` WHERE team_name='$team_name'") or die ("databse fetch problem");
while($row=mysqli_fetch_array($result))
{
...
<div id="arrDebug"></div>
<form method="post" action="check9.php">
...
<pre id="question_css">
Miss Pratima(a Geographer) was hired by the Hamiltonian government(a newly 
formed country).She was instructed to mark states in such a way that they 
form a square. Being lazy, she took 4 co-ordinates pointed by her servant 
to check whether they form a square or not.

Input: four co-ordinates(x y), one per line. Each line should have x and y 
co-ordinates separated by a space.

Output: Yes or No, if they form a square or not respectively.
...
Question : 
State Yes or No whether these co-ordinates form a square or not.
26 34
16 34
26 15
16 15
